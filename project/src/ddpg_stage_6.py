...
class Trainer:
    ...
    def save_models(self, episode_count):
        ...
        torch.save(self.target_actor.state_dict(), dirPath + '/Models2/ddpg/hwasu_stage_6/new_result/' + str(episode_count) + '_actor.pt')
        torch.save(self.target_critic.state_dict(), dirPath + '/Models2/ddpg/hwasu_stage_6/new_result/' + str(episode_count) + '_critic.pt')
       
        print('****Models saved***')
        
    def load_models(self, episode):

        self.actor.load_state_dict(torch.load(dirPath + '/Models2/ddpg/hwasu_stage_6/new_result/' + str(episode) + '_actor.pt'))
        self.critic.load_state_dict(torch.load(dirPath + '/Models2/ddpg/hwasu_stage_6/new_result/' + str(episode)+ '_critic.pt'))
...
reward_path = dirPath + '/Models2/ddpg/hwasu_stage_6/new_result/train_stage_6_reward_result.txt'
time_path = dirPath + '/Models2/ddpg/hwasu_stage_6/new_result/train_stage_6_time_result.txt'

STATE_DIMENSION = 34 #14
ACTION_DIMENSION = 2
ACTION_V_MAX = 0.8 #0.22 # m/s
