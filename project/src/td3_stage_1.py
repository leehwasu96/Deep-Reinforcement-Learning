...
class Trainer:
    ...
    def save_models(self, episode):
        ...
        torch.save(self.target_actor.state_dict(), dirPath + '/Models/td3/hwasu_stage_1/new_result/' + str(episode) + '_actor.pt')

        torch.save(self.target_critic1.state_dict(), dirPath + '/Models/td3/hwasu_stage_1/new_result/' + str(episode) + '_critic1.pt')

        torch.save(self.target_critic2.state_dict(), dirPath + '/Models/td3/hwasu_stage_1/new_result/' + str(episode) + '_critic2.pt')
   
        print('***** stage 1 -> Episode: '+str(episode)+' Model save... *****')
        
        #print('****Models saved***')
        
    def load_models(self, episode):

        self.actor.load_state_dict(torch.load(dirPath + '/Models/td3/hwasu_stage_1/new_result/' + str(episode) + '_actor.pt'))

        self.critic1.load_state_dict(torch.load(dirPath + '/Models/td3/hwasu_stage_1/new_result/' + str(episode)+ '_critic1.pt'))

        self.critic2.load_state_dict(torch.load(dirPath + '/Models/td3/hwasu_stage_1/new_result/' + str(episode)+ '_critic2.pt'))

        print('***** stage 1 -> Episode: '+str(episode)+' Model load... *****')
...
reward_path = dirPath + '/Models/td3/hwasu_stage_1/new_result/train_stage_1_reward_result.txt'
time_path = dirPath + '/Models/td3/hwasu_stage_1/new_result/train_stage_1_time_result.txt'
