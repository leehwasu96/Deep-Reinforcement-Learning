...
class Trainer:
    ...
    def save_models(self, episode):
        ...
        torch.save(self.target_actor.state_dict(), dirPath + '/Models/ddpgfd/hwasu_stage_3/new_result3/' + str(episode) + '_actor.pt')

        torch.save(self.target_critic.state_dict(), dirPath + '/Models/ddpgfd/hwasu_stage_3/new_result3/' + str(episode) + '_critic.pt')
    ...
    def load_models(self, episode):
        ...
        self.actor.load_state_dict(torch.load(dirPath + '/Models/ddpgfd/hwasu_stage_3/new_result3/' + str(episode) + '_actor.pt'))

        self.critic.load_state_dict(torch.load(dirPath + '/Models/ddpgfd/hwasu_stage_3/new_result3/' + str(episode)+ '_critic.pt'))
...
MAX_EPISODES = 1000
MAX_STEPS = 1000
MAX_BUFFER = 200000 #int(1e6) #200000
reward_list = []
train_time_list = []

reward_path = dirPath + '/Models/ddpgfd/hwasu_stage_3/new_result3/train_stage_3_reward_result.txt'
time_path = dirPath + '/Models/ddpgfd/hwasu_stage_3/new_result3/train_stage_3_time_result.txt'
...
ram = PrioritizedReplayBuffer(MAX_BUFFER, alpha=0.3, beta_init=1.0, beta_inc_n=100, seed=1000) # alpha = 0.3

# load demo data to PER #
#demonstrations = load_demonstrations('/home/unicon1/catkin_ws/src/project/src/demonstrations_data_stage_3_10000goals.pkl') #demonstrations_data_stage_3.pkl
...
load_model_episode = 1000                           # 0 is pretrain model load
trainer.load_models(episode=load_model_episode) # 0 is pretrain model load

if __name__ == '__main__':
    rospy.init_node('ddpgfd_stage_3')
