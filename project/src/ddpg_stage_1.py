...
class Trainer:
    ...
    def save_models(self, episode_count):
        ...
        torch.save(self.target_actor.state_dict(), dirPath + '/Models/td3/hwasu_stage_1/new_result/' + str(episode_count) + '_actor.pt')
        torch.save(self.target_critic.state_dict(), dirPath + '/Models/td3/hwasu_stage_1/new_result/' + str(episode_count) + '_critic.pt')
    ...
    def load_models(self, episode):
        ...
        self.critic.load_state_dict(torch.load(dirPath + '/Models/td3/hwasu_stage_1/new_result/' + str(episode)+ '_critic.pt'))
...
if __name__ == '__main__':
    ...
    for ep in range(load_model_episode+1, MAX_EPISODES+1):
        ...
        for step in range(1, MAX_STEPS+1):
            ...
            step_end = time.time()
            step_time = round(step_end-step_start, 2)
            print("step time: %f [s]" % step_time)    
